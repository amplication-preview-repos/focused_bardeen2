...
@InputType()
class UserMeasurementsUpdateInput {
  @ApiProperty({
    required: false,
    type: Number,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => FitPredictionUpdateManyWithoutUserMeasurementsItemsInput,
  })
  @ValidateNested()
  @Type(() => FitPredictionUpdateManyWithoutUserMeasurementsItemsInput)
  @IsOptional()
  @Field(() => FitPredictionUpdateManyWithoutUserMeasurementsItemsInput, {
    nullable: true,
  })
...
export { UserMeasurementsUpdateInput as UserMeasurementsUpdateInput };
